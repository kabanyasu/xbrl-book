...
@<embed>{|html|<img height=300 alt="Chromeの設定を開く" src="images/0301_chromeの設定をクリック.png">}
...
@<embed>{|html|<img height=300 alt="サードパーティCookieの設定を開く" src="images/0308_サードパーティクッキーをクリック.png">}

「サードパーティCookieを許可する」にチェックを入れます。

@<embed>{|html|<img height=500 alt="サードパーティのCookieを許可する" src="images/0309_サードパーティ設定.png">}
...
@<embed>{|html|<img width=300 alt="EDINET APIのサインイン画面" src="images/0310_サインイン画面.png">}

サインアップ画面の上のフォームにメールアドレスを入力し、「確認コードを送信」をクリックします。

@<embed>{|html|<img width=300 alt="メールアドレスを入力し確認コードを受信する" src="images/0311_ユーザー詳細入力画面1.png">}

確認コードを入力し、「コードの確認」へ進みます。

@<embed>{|html|<img width=300 alt="確認コードを入力" src="images\0312_ユーザー詳細入力画面2.jpg">}
...
@<embed>{|html|<img width=300 alt="ユーザーパスワードを入力" src="images\0313_ユーザーパスワード入力画面.png">}
...
@<embed>{|html|<img width=300 alt="多要素認証を行う" src="images\0314_多要素認証.png">}
...
@<embed>{|html|<img width=450 alt="連絡先保存確認画面" src="images\0317_連絡先保存確認画面.png">}

@<embed>{|html|<img width=450 alt="連絡先保存完了画面" src="images\0318_連絡先保存完了画面.png">}
